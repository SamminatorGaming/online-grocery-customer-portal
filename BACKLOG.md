...
## Online Grocery Store Customer Portal

This backlog tracks the work for the Customer Portal project. The team will update the status of each item as work is started, finished, or changed.
...
|---|---|---|---|---|---|
| B-1 | Register account | Customer can create an account with name, email, and password. | Member 1 | High | Done |
| B-2 | Login | Customer can log in with email and password. | Member 1 | High | Done |
| B-3 | Logout | Customer can log out of their account. | Member 1 | Medium | Done |
...
| B-15 | Apply discount code | Customer can enter a discount code during checkout. | Member 4 | Medium | Done |
| B-16 | Calculate tax | System calculates 8.25% tax during checkout. | Member 4 | High | Done |
...
| B-25 | Workload report | Team writes the final workload distribution report. | All Members | High | Not Started |
